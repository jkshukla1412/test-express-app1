...
/*async function test() {
    try {
      ...
      const projectById = await getProjectById(9);
      console.log("Project by ID (9):", projectById);

      const projectsBySector = await getProjectsBySector("Industry");
      console.log("Projects by Sector (Industry):", projectsBySector);
